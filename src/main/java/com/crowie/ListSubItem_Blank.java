...
import toggle.ToggleComponents;

public class ListSubItem_Blank extends toggle.Item.SubItem {

    private final String hoverIcon = "SVGImages/item_card_lined.svg";

    private Image imagenHover;

    public ListSubItem_Blank() {
        initComponents();
    ...
    public ListSubItem_Blank(Component componentToClone) {
        initComponents();
